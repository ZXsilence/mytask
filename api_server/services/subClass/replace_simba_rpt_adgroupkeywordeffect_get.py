...
class ReplaceSimbaRptAdgroupkeywordeffectGet(ReplaceBase):
    '''
    关键词效果报表替换
    '''
    def replace_ret_values(self):
        ...
        from report_db.db_models_sample.rpt_keywordeffect import RptKeywordeffectSample
        ...
        logger2.info("获取关键词效果报表成功！start_time:%s,end_time:%s,nick:%s,campaign_id:%s,adgroup_id:%s" % (self.start_time,self.end_time,self.nick,self.campaign_id,self.adgroup_id))
