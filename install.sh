...
then
    ln -s "${proPath}/comm_lib/tao_models/conf/test/settings.py" "${proPath}/comm_lib/tao_models/conf/"
    ln -s "${proPath}/comm_lib/tao_models/conf/test/set_env.py" "${proPath}/comm_lib/tao_models/conf/"
    ...
    ln -s "${proPath}/comm_lib/service_server/conf/test/set_env.py" "${proPath}/comm_lib/service_server/conf/"
    ln -s "${proPath}/comm_lib/service_server/conf/test/settings.py" "${proPath}/comm_lib/service_server/conf/"
    ln -s "${proPath}/comm_lib/api_parallel/test/celeryconfig_result.py" "${proPath}/comm_lib/api_parallel/"
elif [ $1_ == "prd_" ]
then
...
then
    ...
    echo "       sh install.sh test      安装开发环境"
fi
