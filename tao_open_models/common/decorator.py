...
from common.exceptions import   DataOutdateException
from common.exceptions import  InvalidAccessTokenException, TaoApiMaxRetryException
        ...
        while True:
            try:
                ...
                if code == TaoOpenErrorCode.APP_CALL_LIMIT :
                    if u'This ban will last for 1 more second' not in e.sub_msg:
                        logger.error(e)
                        raise TaoApiMaxRetryException("daily quota meets, do not need to retry")
