...
class OperationType(object):
    ...
    ALL_KEYWORD_UPDATE_TYPES = [
        ...
        UPDATE_PRICE_COST_FULL_DECRE_PRICE,#nouse
        UPDATE_PRICE_GARBAGE_INCRE_PRICE,#nouse
        UPDATE_PRICE_NOCLICK_INCRE_PRICE,#nouse
        UPDATE_PRICE_MINIMIZE_CPC_MAX,#nouse
        UPDATE_PRICE_TO_INCREASE_COST,#nouse
        UPDATE_PRICE_TO_DECREASE_COST,#nouse
        UPDATE_PRICE_TO_APPROVE_ROI,#nouse
        UPDATE_PRICE_DIRECTOR,#nouse
        UPDATE_PRICE_HISTORY_NORMAL,#nouse
        UPDATE_KEYWORD_MOBILE_PRICE_NORMAL,
        UPDATE_PRICE_COST_LESS_THAN_LIMIT_INCRE_PRICE,#nouse
        UPDATE_PRICE_CUSTOM,
        UPDATE_PRICE_GOOD_POSITION_INCRE_PRICE,#nouse
        UPDATE_PRICE_GOOD_POSITION_DECRE_PRICE,#nouse
        ...
        UPDATE_PRICE_FOR_CPC_MAX,#nouse
