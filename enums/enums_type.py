...
class OperationType(object):
    ...
    UPDATE_PRICE_MOBILE_COST_SUFF_INCRE_PRICE = 219
    ...
    START_ADGROUP_FROM_COST_MONITOR_CHOICE_FIRST = 521
    START_ADGROUP_FROM_COST_MONITOR_CHOICE_SECOND = 522
    ...
    START_CAMPAIGN_FROM_COST_MONITOR_CHOICE_FIRST = 631
    START_CAMPAIGN_FROM_COST_MONITOR_CHOICE_SECOND = 632
    ...
    ALL_UPDATE_TYPES = [
        ...
        UPDATE_PRICE_MOBILE_COST_SUFF_INCRE_PRICE,
        ...
        START_CAMPAIGN_FROM_COST_MONITOR_CHOICE_FIRST,
        START_CAMPAIGN_FROM_COST_MONITOR_CHOICE_SECOND,
        STOP_CAMPAIGN_FROM_COST_MONITOR,
        START_ADGROUP_FROM_COST_MONITOR_CHOICE_FIRST,
        START_ADGROUP_FROM_COST_MONITOR_CHOICE_SECOND,
...
OPTTYPE_COMMENT = {
    ...
    , OperationType.UPDATE_PRICE_COST_FULL_DECRE_PRICE : "计划昨日达到日限额下线，花费过高，关键词减小投入"
    , OperationType.UPDATE_PRICE_GARBAGE_INCRE_PRICE : "为获取关键词展现，加大投入"
    , OperationType.UPDATE_PRICE_NOCLICK_INCRE_PRICE : "为获取关键词点击，加大投入"
    , OperationType.UPDATE_PRICE_MINIMIZE_CPC_MAX : "关键词超出设置的最高点击单价，降低出价"
    , OperationType.UPDATE_PRICE_TO_INCREASE_COST : "加大投入，关键词进行价格调整"
    , OperationType.UPDATE_PRICE_TO_DECREASE_COST : "减小投入，关键词进行价格调整"
    ...
    , OperationType.UPDATE_PRICE_MOBILE_COST_FULL_DECRE_PRICE: "计划昨日达到日限额下线，花费过高，关键词减小移动投入"
    , OperationType.UPDATE_PRICE_MOBILE_COST_SUFF_INCRE_PRICE: "计划昨日花费过低，远未达到日限额，关键词加大移动投入"
    , OperationType.UPDATE_PRICE_MOBILE_TO_INCREASE_COST : "加大移动投入，关键词进行价格调整"
    , OperationType.UPDATE_PRICE_MOBILE_TO_DECREASE_COST : "减小移动投入，关键词进行价格调整"
    , OperationType.UPDATE_PRICE_MOBILE_NOCLICK_INCRE_PRICE : "获取关键词点击，加大移动投入"
    ...
    , OperationType.IGNORE_ADGROUP_TOO_MUCH: "调整优化"
    ...
    ,OperationType.START_CAMPAIGN_FROM_COST_MONITOR_CHOICE_FIRST: '恢复推广，并且今天不再监控该计划'
    ,OperationType.START_CAMPAIGN_FROM_COST_MONITOR_CHOICE_SECOND: '恢复推广，并且今天继续监控该计划'
    ,OperationType.STOP_CAMPAIGN_FROM_COST_MONITOR: '花费异常，暂停计划'
    ,OperationType.START_ADGROUP_FROM_COST_MONITOR_CHOICE_FIRST: '恢复推广，并且今天不再监控该推广组'
    ,OperationType.START_ADGROUP_FROM_COST_MONITOR_CHOICE_SECOND: '恢复推广，并且今天继续监控该推广组'
