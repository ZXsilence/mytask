...
class CampaignType(object):
    ...
    CAMPAIGN_REAL_ADGROUP_AUCTION_STRATEGY = 80
    ...
    ALL_CAMPAIGN_TYPES = [
        ...
        CAMPAIGN_REAL_ADGROUP_AUCTION_STRATEGY,
...
class AdgroupType(object):
    ...
    ADGROUP_KEYWORD_YES_CTR_UNNORMAL = 403
    ADGROUP_KEYWORD_WEEK_CTR_UNNORMAL = 404
    ADGROUP_KEYWORD_RT_CTR_UNNORMAL = 405
    ...
    ALL_ADGROUP_TYPES = [
        ...
        ADGROUP_KEYWORD_YES_CTR_UNNORMAL,
        ADGROUP_KEYWORD_WEEK_CTR_UNNORMAL,
        ADGROUP_KEYWORD_RT_CTR_UNNORMAL
        ]
...
CODE_TO_TYPE = {
        ...
        ,80:'CAMPAIGN_REAL_ADGROUP_AUCTION_STRATEGY'
        ...
        ,402:'ADGROUP_BUDGET_OUT_LIMIT'
        ,403:'ADGROUP_KEYWORD_YES_CTR_UNNORMAL'
        ,404:'ADGROUP_KEYWORD_WEEK_CTR_UNNORMAL'
        ,405:'ADGROUP_KEYWORD_RT_CTR_UNNORMAL'
...
class AdgroupBudgetType(object):
    ...
    BUDGET_REDUCE_3_LV = 3
    BUDGET_REDUCE_FORCE_LV = 4
    BUDGET_RAISE_1_LV = 11
    BUDGET_RAISE_2_LV = 12
