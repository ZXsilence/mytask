...
from TaobaoSdk import ZuanshiAdvertiserTransRptsDownloadRequest 
...
class ZuanshiTransRptsDownload(object):
...
if __name__ == '__main__':
    ...
    rpt_type = 3
    try_list = ZuanshiTransRptsDownload.get_rpts_task(nick,start_date,end_date,rpt_type)
    print try_list
