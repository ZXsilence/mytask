...
class ZuanshiCreativeRptsDayGet(object):
    ...
    @classmethod
    @tao_api_exception()
    def get_creative_rpts_day(cls, nick,campaign_id,start_time,end_time,adgroup_id,creative_id,effect = 15,campaign_model = 1,effect_type ='impression',soft_code = 'YZB'):
