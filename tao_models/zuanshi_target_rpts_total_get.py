...
from TaobaoSdk import ZuanshiAdvertiserTargetRptsTotalGetRequest
...
class ZuanshiTargetRptsTotalGet(object):
    ...
    def __sub_get_target_rpts_total(cls, nick,sdate,edate,effect = 15,campaign_model= 1,effect_type  = 'impression',page_num = 1,campaign_id = None,adgroup_id = None,target_id = None,soft_code = 'YZB'):
        ...
        return change2num2(change_obj_to_dict_deeply(rsp.target_offline_rpt_total_list),True)
