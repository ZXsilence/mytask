...
from TaobaoSdk import ZuanshiAdvertiserTargetRptsDayGetRequest 
...
class ZuanshiTargetRptsDayGet(object):

    @classmethod
    @tao_api_exception()
    def get_target_rpts_day(cls, nick,campaign_id,start_time,end_time,adgroup_id,target_id,effect = 15,campaign_model = 1,effect_type ='click',soft_code = 'YZB'):
        ...
        return change_obj_to_dict_deeply(rsp.target_offline_rpt_days_list)
