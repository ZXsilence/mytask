...
from tao_models.num_tools import change2num2,default_zero_value_fields_rt
...
class ZuanshiAccountRtRptsGet(object):
    ...
    def get_account_rt_rpts(cls, nick,rpt_date,campaign_model =1,soft_code = 'YZB'):
        ...
        return change2num2(change_obj_to_dict_deeply(rsp.advertiser_realtime_rpt_list),True,default_zero_value_fields_rt)
