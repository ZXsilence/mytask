...
class SimbaRptAdgroupEffectGet(object):
    ...
    def get_rpt_adgroupeffect_list(cls, nick, campaign_id, adgroup_id, start_time, end_time, search_type, source):
        ...
        for item in date_list:
            rpt_list.extend(cls._get_rpt_adgroupeffect_list(nick,campaign_id,adgroup_id,item[0],item[1],search_type,source))
        return rpt_list

    @classmethod
    def _get_rpt_adgroupeffect_list(cls, nick, campaign_id, adgroup_id, start_time, end_time, search_type, source):
        """
        Notes:
