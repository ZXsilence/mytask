...
class AdgroupNotExistException(Exception):
    """
    raise this exception when taobao_client excute error  
    """
    def __init__(self, msg = None, sub_msg = None):
    ...
    def __str__(self):
        return "AdgroupNotExistException:msg [%s] sub_msg [%s]" % (self.msg, self.sub_msg)


class KeywordsFullException(Exception):
    """
    raise this exception when taobao_client excute error  
    """
    def __init__(self, msg = None, sub_msg = None):
...
class W2securityException(Exception):
    """
    raise this exception when taobao_client excute error  
    """
    def __init__(self, msg = None, sub_msg = None):
    ...
    def __str__(self):
        return "W2securityException:msg [%s] sub_msg [%s]" % (self.msg, self.sub_msg)
...
class NoPermissionException(Exception):
    ...
    def __str__(self):
        return "NoPermissionException:msg [%s] sub_msg [%s]" % (self.msg, self.sub_msg)
