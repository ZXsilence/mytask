...
class ZuanshiCreativeRptsTotalGet(object):
    ...
    @classmethod
    def get_creative_rpts_total(cls, nick,sdate,edate,effect = 15,campaign_model= 1,effect_type  = 'impression',page_num = 1,campaign_id = None,adgroup_id = None,creative_id = None,soft_code = 'YZB'):
        rpt_list = []
        while True:
    ...
    @classmethod
    @tao_api_exception()
    def __sub_get_creative_rpts_total(cls, nick,sdate,edate,effect = 15,campaign_model= 1,effect_type  = 'impression',page_num = 1,campaign_id = None,adgroup_id = None,creative_id = None,soft_code = 'YZB'):
