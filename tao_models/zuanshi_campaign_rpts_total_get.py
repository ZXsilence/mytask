...
from TaobaoSdk import ZuanshiAdvertiserCampaignRptsTotalGetRequest
...
class ZuanshiCampaignRptsTotalGet(object):
    ...
    @classmethod
    def get_campaign_rpts_total(cls, nick,sdate,edate,effect = 15,campaign_model= 1,effect_type  = 'impression',page_num = 1,campaign_id = None,soft_code = 'YZB'):
        rpt_list = []
        while True:
    ...
    @classmethod
    @tao_api_exception()
    def __sub_get_campaign_rpts_total(cls, nick,sdate,edate,effect = 15,campaign_model= 1,effect_type  = 'impression',page_num = 1,campaign_id = None,soft_code = 'YZB'):
        ...
        return change2num2(change_obj_to_dict_deeply(rsp.campaign_offline_rpt_total_list),True)
...
if __name__ == '__main__':
    ...
    for obj in try_list:
        print obj.keys()
        print obj['campaign_id'],obj['campaign_name'],obj['uv'],obj['ad_pv'],obj['ctr'],obj['ecpm'],obj['charge'],obj.get('cvr',0),obj['roi']
