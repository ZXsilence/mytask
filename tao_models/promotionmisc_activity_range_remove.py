...
from TaobaoSdk import PromotionmiscActivityRangeRemoveRequest
...
class PromotionmiscActivityRangeRemove(object):
...
if __name__ == "__main__":
    ...
    num_iids = [123]
    range_list = PromotionmiscActivityRangeRemove.remove_promotionm_activity_range(nick,activity_id,num_iids)
    print range_list
