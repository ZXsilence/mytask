...
from TaobaoSdk import ZuanshiAdvertiserCampaignRtrptsGetRequest 
...
class ZuanshiCampaignRtRptsGet(object):

    @classmethod
    @tao_api_exception()
    def get_campaign_rt_rpts(cls, nick,rpt_date,campaign_id,campaign_model =1,soft_code = 'YZB'):
        ...
        return change2num2(change_obj_to_dict_deeply(rsp.campaign_realtime_rpt_list),True,default_zero_value_fields_rt)
