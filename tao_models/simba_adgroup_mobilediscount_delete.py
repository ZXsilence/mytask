...
from TaobaoSdk import SimbaAdgroupMobilediscountDeleteRequest 
...
if __name__ == '__main__':
    ...
    print SimbaAdgroupMobilediscountDelete.delete_mobile_discount_by_adgroup_ids(nick,adgroup_ids)
