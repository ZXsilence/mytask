...
class SimbaKeywordscatQscoreGet(object):
    ...
    @classmethod
    @tao_api_exception()
    def get_qscore_list_by_adgroup(cls, access_token, nick, adgroup_id):
        """
...
def test():
    ...
    nick = 'chinchinstyle'
    qscore_list = SimbaKeywordscatQscoreGet.get_qscore_list_by_adgroup(access_token, nick, 169469163)
    for qscore in qscore_list.keyword_qscore_list:
        print qscore.toDict()
