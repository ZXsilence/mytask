...
from TaobaoSdk.Request.SimbaSerchcrowdBatchDeleteRequest import SimbaSerchcrowdBatchDeleteRequest
...
class SimbaSerchcrowdBatchDelete(object):

    @classmethod
    @tao_api_exception()
    def serchcrowdbatch_delete(cls, nick, sub_nick, adgroup_crowd_ids, soft_code):
