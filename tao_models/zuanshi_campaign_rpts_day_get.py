...
class ZuanshiCampaignRptsDayGet(object):
    ...
    @classmethod
    @tao_api_exception()
    def get_campaign_rpts_day(cls, nick,campaign_id,start_time,end_time,effect = 15,campaign_model = 1,effect_type ='impression',soft_code = 'YZB'):
        ...
        return change2num2(change_obj_to_dict_deeply(rsp.campaign_offline_rpt_days_list),True)
