...
from TaobaoSdk import PromotionmiscItemActivityGetRequest 
...
class PromotionmiscItemActivityGet(object):
...
if __name__ == "__main__":
    nick = "麦苗科技001"
    activity_id = 399210710 
    activity = PromotionmiscItemActivityGet.get_promotionm_item_activity(nick,activity_id)
    print activity 
