...
from vas_subsc_search import VasSubscSearch


@unittest.skipUnless('regression' in settings.RUNTYPE, "Regression Test Case")
class TestVasSubscSearch(unittest.TestCase):
    '''
    订购记录导出 
    ...
    def setUpClass(cls):
        ...
        cls.testData = [{'nick':'麦苗科技001','soft_code':'SYB','start_time':datetime.date.today(),'popException':False,'exceptClass':None},
