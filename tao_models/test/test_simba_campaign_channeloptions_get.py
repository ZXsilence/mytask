...
from simba_campaign_channeloptions_get import SimbaCampaignChanneloptionsGet
from tao_models.common.exceptions import TaoApiMaxRetryException
from tao_models.common.exceptions import InvalidAccessTokenException
from TaobaoSdk.Exceptions import ErrorResponseException
@unittest.skipUnless('regression' in settings.RUNTYPE, "Regression Test Case")
class TestSimbaCampaignChanneloptionsGet(unittest.TestCase):
    '''
    ...
    def setUpClass(cls):
        ...
        cls.tcinfo = 'API Test - taobao.simba.campaign.channeloptions.get'
        ...
        cls.itemFields = 'name,is_search,channel_id,traffic_type,is_nonsearch,traffic_name'.split(',')
    ...
    def test_get_campaign_area(self):
        for inputdata in self.testInputDatas:
            self.tcinfo = 'API Test - taobao.simba.campaign.channeloptions.get'
            self.tcinfo += str(inputdata)
            is_poped = False
            try:
                returnValue = SimbaCampaignChanneloptionsGet.get_campaign_channeloptions(inputdata['nick'])
...
alltests = unittest.TestLoader().loadTestsFromTestCase(TestSimbaCampaignChanneloptionsGet)
