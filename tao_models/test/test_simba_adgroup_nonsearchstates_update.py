...
class TestSimbaAdgroupNonsearchstatesUpdate(unittest.TestCase):
    '''
    ...
    def test_set_adgroups_nonsearchstates(self):
        """No Use"""
        pass
...
alltests = unittest.TestLoader().loadTestsFromTestCase(TestSimbaAdgroupNonsearchstatesUpdate)
