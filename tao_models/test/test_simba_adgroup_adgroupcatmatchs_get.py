...
class TestSimbaAdgroupAdgroupcatmatchsGet(unittest.TestCase):
    '''
    ...
    def setUpClass(cls):
        ...
        cls.tcinfo = 'API Test - taobao.simba.adgroup.catmatch.get'
    ...
    def test_get_adgroup_catmatchs(self):
        """No Use"""
        pass
...
alltests = unittest.TestLoader().loadTestsFromTestCase(TestSimbaAdgroupAdgroupcatmatchsGet)
