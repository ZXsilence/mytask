...
class TestPictureCategoryAdd(unittest.TestCase):
    '''
    ...
    def setUpClass(cls):
        ...
        cls.tcinfo = 'API Test - taobao.picture.category.add'
    ...
    def test_add_picture_category(self):
        """No Use"""
        pass
...
alltests = unittest.TestLoader().loadTestsFromTestCase(TestPictureCategoryAdd)
