...
class test_simba_keywordsbykeywordids_get(unittest.TestCase):
    ...
    def test_sub_get_keyword_list_by_keyword_ids(self):
        data = [{'nick':'晓迎','keywordids_list':[213203352285,213627522040,64799840462],
...
if __name__ == "__main__":
    unittest.main()
alltests = unittest.TestLoader().loadTestsFromTestCase(test_simba_keywordsbykeywordids_get)
