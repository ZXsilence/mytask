...
class TestSimbaAdgroupNonsearchpricesUpdate(unittest.TestCase):
    '''
    ...
    def setUpClass(cls):
        ...
        cls.tcinfo = 'API Test - taobao.simba.adgroup.nonsearchprices.update'
    ...
    def test_set_adgroups_nonsearchprices(self):
        """No Use"""
        pass
...
alltests = unittest.TestLoader().loadTestsFromTestCase(TestSimbaAdgroupNonsearchpricesUpdate)
