...
from TaobaoSdk import PromotionmiscActivityRangeListGetRequest
...
class PromotionmiscActivityRangeListGet(object):
...
if __name__ == "__main__":
    ...
    range_list = PromotionmiscActivityRangeListGet.get_promotionm_activity_range(nick,activity_id)
    print range_list
