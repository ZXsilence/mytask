...
from TaobaoSdk import ZuanshiAdvertiserAdzoneRptsDownloadRequest
...
class ZuanshiAdzoneRptsDownload(object):
...
if __name__ == '__main__':
    ...
    rpt_type = 3
    try_list = ZuanshiAdzoneRptsDownload.get_rpts_task(nick,start_date,end_date,rpt_type)
    print try_list
